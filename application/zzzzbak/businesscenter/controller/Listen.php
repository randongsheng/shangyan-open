...
class Listen extends Common
{
	...
	public function orderInfo(){
		...
		$order = db('order')->field('orderid,ordermoney,topic,clinicid,paymode,uid,content,serverpersonid,alltime')->where(['orderid'=>$orderid])->find();
		...
		$listenrecord = db('listenrecord r')->field('r.id,stime,etime,timelong,sytime,score,content')->join('listencomment c','r.id=c.recordid','LEFT')->where(['orderid'=>$orderid])->select();
		//print_r($ordermore);
